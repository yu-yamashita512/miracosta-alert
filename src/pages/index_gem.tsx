...
// カラーパレット定義（Tailwindのクラス内で使用）
// Base: #0C1445 (Deep Night Blue)
// Accent: #C5A059 (Stardust Gold)
// Text: #F0F4F8 (Moonlight White)
// Action: #A51C30 (Rose Red)

export default function RoyalConciergeHome() {
